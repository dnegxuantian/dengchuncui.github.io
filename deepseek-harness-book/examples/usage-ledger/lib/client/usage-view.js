...
export function inputTokens(value) {
...
export function cacheHitRate(value) {
...
export function modelCalls(value) {
...
export function hasCompleteCost(value) {
...
export function aggregateUsage(rows) {
    ...
    for (const row of rows) {
        ...
        if (result.currency !== row.usage.currency)
    ...
    result.byModel = [...models.values()].sort((a, b) => totalTokens(b) - totalTokens(a)
