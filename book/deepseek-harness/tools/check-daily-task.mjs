...
const session=readonly?'session-f0c35466-640a-4378-8e41-16f6e9f4bb0a':'session-046d6508-4f00-49fb-97a3-c19c2c5afb35';
...
const stem=readonly?'daily-readonly':'daily-task';
writeFileSync(new URL(`edition-2/${stem}-evidence.json`,root),JSON.stringify(evidence,null,2)+'\n');
writeFileSync(new URL(`edition-2/${stem}-actual.md`,root),'# 日报任务的实际回答\n\n'+answer+'\n');
