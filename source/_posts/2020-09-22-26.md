---
title: 集合类框架 hashmap 源码详解
date: '2020-09-22 12:05:48'
updated: '2021-05-04 14:18:23'
categories:
- java
tags:
- java基础
- 源码
- hashmap
description: 介绍HashMap 可能是面试的时候必问的题目了，面试官为什么都偏爱拿这个问应聘者？因为 HashMap 它的设计结构和原理比较有意思，它既可以考初学者对
  Java 集合的了解又可以深度的发现应聘者的数据结构功底。 Java 7 中 HashMapHashMap 是最简单的，一来我们非常熟悉，二来就是它不支持并发操作……
cover: /images/covers/java.svg
top_img: /images/covers/java.svg
permalink: /2020/09/22/ java【集合类框架】 hashmap 源码详解/
comments: false
---

### 介绍

HashMap 可能是面试的时候必问的题目了，面试官为什么都偏爱拿这个问应聘者？因为 HashMap 它的设计结构和原理比较有意思，它既可以考初学者对 Java 集合的了解又可以深度的发现应聘者的数据结构功底。

### Java 7 中 HashMap

HashMap 是最简单的，一来我们非常熟悉，二来就是它不支持并发操作，所以源码也非常简单。d

首先，我们用下面这张图来介绍 HashMap 的结构。

<figure class="legacy-image-notice" data-original-src="https://dmr-blog.oss-cn-shanghai.aliyuncs.com/blog/image_1586585802287.png">
...
<figure class="legacy-image-notice" data-original-src="https://dmr-blog.oss-cn-shanghai.aliyuncs.com/blog/image_1586585882830.png">
<img src="/images/legacy-missing.svg" alt="image.png" />
...
注意：\
对于那些 hash 冲突的数据，最新(最后) Put 的值放在链表的头部，为什么这样做呢？因为我们程序设计中认为最新放进去的值它的使用率会更高些，放在链表头比较容易查询获取到。
...
<figure class="legacy-image-notice" data-original-src="https://dmr-blog.oss-cn-shanghai.aliyuncs.com/blog/image_1586586239096.png">
<img src="/images/legacy-missing.svg" alt="image.png" />
