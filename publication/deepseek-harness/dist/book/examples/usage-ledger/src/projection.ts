...
const stateSchema: z.ZodType<ModelCostState> = z.object({
...
// Preserve the package's pure replay API while declaring the installed Harness 0.1.1 wire API.
type ModelCostDefinition = ProjectionDefinition<'modelCost', ModelCostState> & {
  stateSchema: z.ZodType<ModelCostState>
  wire: { viewSchema: z.ZodType<ModelCostProjection>, view(state: ModelCostState): ModelCostProjection }
}
